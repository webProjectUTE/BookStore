...
<body>
	...
	<div class="main">
		<div class="main-header">
			...
			<div class="main-title">Review Management</div>
		</div>
								...
								<tbody>
									<c:forEach var="review" items="${listReviews}"
										...
										<tr>
											...
											<td><span
												class="order-status order-shipped fontsize12px">
													${review.rating} </span></td>

											<td><span
												class="order-status order-shipped fontsize12px">
													${review.headline} </span></td>


											<td><span
												class="order-status order-shipped fontsize12px">
													${review.customer.fullname} </span></td>

											<td><span
												class="order-status order-shipped fontsize12px"> <fmt:formatDate
														pattern='MM/dd/yyyy' value='${review.reviewTime}' /></span></td>

											<td><a href="edit_review?id=${review.reviewId}"><i
													class='bx bx-edit bx-flip-horizontal'></i>Edit |</a> &nbsp; <a
												href="javascript:void(0);" class="deleteLink"
												id="${review.reviewId}"> <i
