...
<head>
    ...
    <title>
        Manage Categories - Bookstore Administration
    </title>
...
<!-- SIDEBAR MENU -->
    ...
    <div class="main">
        ...
        <div class="main-title"> Category Management
        </div>
        </div>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="edit_category?id=${cat.categoryId}"><i
				class='bx bx-edit bx-flip-horizontal'></i>Edit |</a> &nbsp; 
                <a href="javascript:void(0);" class="deleteLink" id="${cat.categoryId}">
                                                <i
