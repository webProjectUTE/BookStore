...
<body>
	...
	<div class="main">
		<div class="main-header">
			...
			<div class="main-title">Book Orders Management</div>
		</div>
							...
							<table>
								<thead>
									<tr>
										...
										<th>Order ID</th>
										<th>Ordered by</th>
										<th style="width: 7%">Book Copies</th>
										<th>Total</th>
								...
								<tbody>
									<c:forEach var="order" items="${listOrder}" varStatus="status">
										<tr>
											...
											<td><span
												class="order-status order-shipped fontsize12px">
													${order.orderId} </span></td>

											<td><span
												class="order-status order-shipped fontsize12px">
													${order.customer.fullname} </span></td>

											<td><span
												class="order-status order-shipped fontsize12px">
													${order.bookCopies} </span></td>

											<td><span
												class="order-status order-shipped fontsize12px"><fmt:setLocale value = "en_US"/> <fmt:formatNumber
											...
											<td><span
												class="order-status order-shipped fontsize12px"> <fmt:formatDate
														pattern='MM/dd/yyyy' value='${order.orderDate}' /></span></td>

											<td><a href="view_order?id=${order.orderId}"><i
													class='bx bx-detail bx-flip-horizontal'></i>Details |</a>
